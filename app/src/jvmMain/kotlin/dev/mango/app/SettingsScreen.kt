 ...
 * needed: the current theme and the change callback are hoisted all the way up to Main.kt so
 * the switch applies live without a restart. Same pattern for the auto-scroll speed.
 */
@Composable
