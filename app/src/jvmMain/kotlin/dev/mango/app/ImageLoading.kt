 ...
 * them to ~230px wide before the reader upscaled them back — the M3.5 "pixelated pages"
 * bug. Height 16384 matches the common GPU max texture size; the rare taller strip still
 * gets downsampled proportionally — splitting tall images into segments is the upgrade path.
 *
